            ...
            <div class="table-container">
                <heder class="table-header">
                    ...
                    <div class="table-header-actions">
                        <div class="buttons">
                            <a href="{{ route('admin.create.student') }}"><i class="material-icons icon">add</i>NEW STUDENT</a>
                        </div>
                        <div class="filters">
                ...
                <div class="table-wrapper">
                    <header class="header">
                        ...
                        <select name="filterByAdviser" id="filterByAdviser">
                            <option value="">Filter By Adviser</option>
                            @foreach ($advisers as $adviser)
                                <option value="{{ $adviser->teacher_id }}">{{ $adviser->first_name }} {{ $adviser->last_name }}</option>
                            @endforeach
                        </select>
