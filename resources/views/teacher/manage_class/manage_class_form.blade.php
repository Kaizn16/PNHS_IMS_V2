    ...
    <section class="wrapper">
        ...
        <div class="content-box">
            <div class="form-container">
                <form action="{{ isset($class) ? route('teacher.update.class', ['class_management_id' => $class->class_management_id]) : route('teacher.store.class') }}" method="POST">
                    @csrf
                    @isset($class)
                        @method('PUT')
                    @endisset
                    ...
                    <div class="form-actions">
                        ...
                        <a href="{{ route('teacher.manageclass') }}"><i class="material-icons icon">cancel</i>CANCEL</a>
                    </div>
...
<script>
    ...
    let isAdviser = @json(isset($teacher) && $teacher->designation === 'Adviser');
    let isTeacher = @json(isset($teacher) && $teacher->designation === 'Teacher');

    if (isAdviser) {
        selectedTeacher = @json($teacher->teacher_id);
    }
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (existingTeacher) {
                    ...
                    console.warn("Teacher not found in API response:", selectedTeacher);
                }
