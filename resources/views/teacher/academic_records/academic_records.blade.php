            ...
            <div class="table-container">
                <heder class="table-header">
                    ...
                    <div class="table-header-actions">
                        <div class="buttons">
                            <a href="{{ route('teacher.create.academic.record') }}"><i class="material-icons icon">add</i>NEW RECORD</a>
                        </div>
                        <div class="filters">
...
@endif
    <script src="{{ asset('assets/js/academic_records/manage_class.js') }}"></script>
@endsection